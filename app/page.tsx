...
function CustomBrandLogo() {
  return (
    ...
    >
      ...
      <span className="text-[9px] md:text-[11px] uppercase tracking-[0.45em] text-[#D4A328] font-bold mt-1 pl-0.5">
        INGLEWOOD
      </span>
    </a>
  );
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-[#D4A328] selection:text-black font-sans overflow-x-hidden">
      ...
      <header
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
          scrolled
            ? 'bg-[#0a0a0a]/95 backdrop-blur-md border-b border-[#D4A328]/20 py-3'
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 flex items-center justify-between">
          ...
          <div>
            <a
              href="#contact"
              className="bg-[#D4A328] hover:bg-[#C29221] text-black font-extrabold text-[10px] md:text-xs uppercase tracking-widest px-4 md:px-6 py-2 md:py-2.5 rounded transition-all shadow-lg shadow-[#D4A328]/20"
            >
              BOOK EVENT
            </a>
          </div>
      ...
      >
        <div className="bg-neutral-900/40 p-6 sm:p-8 md:p-12 rounded-2xl border border-neutral-800 backdrop-blur-sm space-y-4 md:space-y-6">
          ...
          {waitlistSubmitted ? (
            <div className="p-4 bg-[#D4A328]/10 border border-[#D4A328]/30 rounded-lg text-[#D4A328] text-xs uppercase tracking-wider font-semibold">
            ...
            >
              <input
                ...
                className="flex-1 bg-black/80 border border-neutral-700 rounded-lg px-4 py-3 text-xs text-white placeholder-gray-500 focus:outline-none focus:border-[#D4A328] transition-colors"
              />
              <button
                type="submit"
                className="bg-[#D4A328] hover:bg-[#C29221] text-black font-bold text-xs uppercase tracking-widest px-6 py-3 rounded-lg transition-all"
              >
                Apply
              </button>
            </form>
        ...
        <div className="bg-neutral-900/50 p-6 sm:p-8 md:p-12 rounded-2xl border border-neutral-800 backdrop-blur-sm shadow-2xl space-y-8">
          {bookingSubmitted ? (
            <div className="text-center py-10 space-y-4">
              <h3 className="text-[#D4A328] font-serif text-2xl font-bold">
            ...
            >
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full bg-black/80 border border-neutral-700 rounded-lg px-4 py-3 text-xs text-white placeholder-gray-500 focus:outline-none focus:border-[#D4A328] transition-colors"
                  />
                </div>
                <div className="space-y-1.5">
                  <label className="text-[10px] md:text-[11px] uppercase tracking-wider text-gray-300 font-medium">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                ...
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    className="w-full bg-black/80 border border-neutral-700 rounded-lg px-4 py-3 text-xs text-white focus:outline-none focus:border-[#D4A328] transition-colors"
                  >
              ...
              <button
                type="submit"
                className="w-full bg-[#D4A328] hover:bg-[#C29221] text-black font-extrabold text-xs uppercase tracking-widest py-3.5 md:py-4 rounded-lg transition-all shadow-xl shadow-[#D4A328]/20"
              >
                Submit Inquiries
              </button>
            </form>
      ...
      <footer className="border-t border-neutral-900 bg-black pt-16 md:pt-20 pb-10 md:pb-12 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 mb-12 md:mb-16">
          ...
          <div className="space-y-3 md:space-y-6">
            <h4 className="text-[10px] uppercase tracking-[0.3em] text-[#D4A328] font-semibold">
              VISIT & CONTACT
            </h4>
